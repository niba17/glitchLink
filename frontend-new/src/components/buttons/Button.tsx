...
export default function Button({
  ...
  const variants: Record<Variant, string> = {
    primary:
      "bg-[#159976] hover:bg-[#0e7056] focus:ring-[#1de2ae] text-stone-200 w-full p-[0.5vw] focus:outline-none focus:ring-[0.1vw] text-[1.3vw]",
    ghost: "bg-transparent text-stone-200 w-full hover:text-stone-400",
